...
if __name__ == "__main__":
    ...
    drop_indexs = []  # collect indexes of rows that will be deprecated.
    ...
    df_new_labevents.to_csv(os.path.join(path_dataset, "LABEVENTS_NEW_remove_duplicate_edges.csv.gz"))
